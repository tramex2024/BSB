...
// --- Función actualizada para interactuar con el botón START/STOP
// Ahora recibe la configuración como un argumento
export async function toggleBotState(botType, config = {}) {
    ...
    try {
        ...
        // --- CÓDIGO NUEVO ---
        // Si el bot se está iniciando, adjunta la configuración al cuerpo de la petición
        if (isStarting) {
...
// --- Las otras funciones de gestión del bot (sin cambios) ---
