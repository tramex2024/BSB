...
async function runBotLogic() {
    ...
    try {
        ...
        switch (botState.state) { // <-- ¡Cambiado de 'status' a 'state'!
            case 'RUNNING':
                ...
                // *** INTEGRACIÓN CON bitmart_indicator_analyzer.js ***
                ...
                if (analysisResult.action === 'COMPRA' && botState.ac === 0) {
            ...
            case 'BUYING':
                ...
                // Lógica de transición a SELLING
                ...
                // Lógica para órdenes de cobertura (si el precio cae)
                    ...
                    if (botState.orderCountInCycle === 0) {
                        nextUSDTAmount = botState.purchaseAmount; // Primera orden tiene monto base
                    } else {
            ...
            case 'SELLING':
                ...
                if (botState.pm === 0 || botState.currentPrice > botState.pm) {
                    ...
                    botState.pc = botState.pm * (1 - 0.004);
    ...
    //             }
                ...
                // Si el precio actual cae por debajo del precio de venta (pv) o el precio de caída (pc)
