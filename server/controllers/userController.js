...
/**
 * Actualiza la versión de la app móvil del usuario y evalúa si hay una actualización disponible
 */
exports.checkAppVersion = async (req, res) => {
    try {
        ...
        // Si el cliente envía la versión, la actualizamos en el registro del usuario
        if (appVersion) {
        ...
        // Comparamos la versión local con la última disponible
        ...
        return res.status(500).json({ 
            success: false, 
            message: 'Error verifying app version' 
        });
    }
};