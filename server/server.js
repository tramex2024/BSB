...
const ordersRoutes = require('./routes/ordersRoutes'); // <- Este es el que necesitamos
...
// app.use('/api/auth', authRoutes); // Descomenta si usas este router
// app.use('/api/users', userRoutes); // Descomenta si usas este router
app.use('/api/orders', ordersRoutes); // <- AÑADIDO: Conecta la ruta de órdenes
...
// ESTA RUTA ESTABA DUPLICADA Y PROVOCABA CONFLICTOS. HA SIDO ELIMINADA.
