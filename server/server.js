...
if (USE_MOCK_DB) {
    ...
    console.log('[MOCK DB]: ⚠️ Using local JSON data store for testing.');
} else {
    // Lógica para la base de datos real
    require('./config/db')(); // Conecta la base de datos real
    Autobot = require('./models/Autobot'); 
    console.log('MongoDB Connected...'); // Esto ya estaba en tu log
}
