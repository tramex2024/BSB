...
// AÑADIDO: Ruta para obtener el balance, las órdenes abiertas y el historial de órdenes
...
        }
        
        // Agregamos logs para las variables que te preocupan
...
        
        // Llama a la función para obtener el historial de órdenes
        const historyOrders = await bitmartService.getHistoryOrders('BTC_USDT');
        console.log('[LOG] Historial de órdenes obtenido:', historyOrders);
        
        // Usamos el precio del mercado que ya tenías
